function postGame(objectAsJson: string, type: string, callbackOnSuccess: Function | undefined) {
...
function getGame(id: string, type: string, callbackOnSuccess: Function | undefined) {
    var isAsync = true;
    var xmlHttp = new XMLHttpRequest();
